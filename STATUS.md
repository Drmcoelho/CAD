...
- ✅ Lote 1 (G-01..G-20) + Lote 2 (G-21..G-40) + Lote 3 (G-41..G-60, todos não-CAD): 60 casos sintéticos, 60 diagnósticos diferentes, verificados por `scripts/check_gasometrias.js` (Henderson-Hasselbalch, distúrbio primário, AG/AGc, hasDka). UI em `painel/index.html`, separada da série real.
- [ ] Lotes 4+ até 100+ casos.
