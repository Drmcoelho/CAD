...
- ✅ **Sortear caso, sem spoiler**: botão "Sortear caso" escolhe um caso aleatório (respeitando o filtro de categoria ativo, sem repetir o sorteio imediatamente anterior) e entra em modo cego — título e badge "imita CAD" ficam ocultos, tanto no painel de detalhe quanto no card destacado na grade, até o aluno clicar em "revelar gabarito". Clique direto num card da lista continua mostrando o título de cara (navegação normal, sem modo cego).
